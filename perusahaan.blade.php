    ...
    <div class="box designer">
        <div class="col-sm-0" >           
             <img src="images/google.png" class="logo rounded-circle " class="img-fluid" alt="">
                  <a href="#" class="btn klik">Selengkapnya</a>
                    <h5> Google
                      <p class="text muted"> Multinasional</p>
                      <p class="text muted"> Jl. Jend. Sudirman No.53, RT.5/RW.3,  Senayan, Kebayoran Baru,South Jakarta City, Jakarta 12190</p>
                    </h5>
            </div>      
        </div>  
    </div>
